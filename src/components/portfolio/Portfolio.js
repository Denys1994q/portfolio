...
const Portfolio = () => {
    ...
    const projects = [
        ...
        {name: 'Fc Arsenal', description: '', img: arsenal, deploy: '', github: 'https://github.com/Denys1994q/Arsenal-React', technologies: ['react', 'react-router-dom', 'sass', 'flex', 'grid', 'git', 'fetch', 'omdb-api', 'weather-api', 'marvel-api', 'heroku', 'videoCINEMA', 'react-image-magnify']},
        {name: 'Chat', description: '', img: chat, deploy: '', github: 'https://github.com/Denys1994q/chat_React', technologies: ['react', 'node-sass', 'sass', 'flex', 'git', 'fetch', 'chuck-norris-jokes-api', 'react-google-login', 'gapi-script', 'heroku']},
